...
export default function AdminPage() {
  ...
  const generateChatGPTPrompt = () => {
    ...
    prompt += `**مهم جداً:** يجب استخدام اسم الفئة بالعربية بشكل دقيق كما هو مكتوب أعلاه.\n\n`
    ...
    prompt += `يرجى إعطائي ${numQuestions} أسئلة موزعة بالتساوي على الفئات المذكورة أعلاه، مع التأكد من استخدام أسماء الفئات بالعربية بشكل دقيق.`
